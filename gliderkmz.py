...
Last modified: lgarzio on 3/13/2024
...
def main(deployment, kml_type, savedir):
...
if __name__ == '__main__':
    deployment = 'active'  # active or maracoos_01-20240124T1612
    ...
    main(deployment, kml_type, savedir)
